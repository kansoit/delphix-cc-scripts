...
#    --expressions-file       -e CSV file: Expressions file                                         expressions.csv
#    --domains-file           -d CSV file: Domains file                                             domains.csv
...
#
# dpxcc_setup_domains.sh
# Created: Horacio Dos - 12/2023
# Parameters:
#
#   dpxcc_setup_domains.sh --help
#
#    Parameter             Short Description                                                        Default
#    --------------------- ----- ------------------------------------------------------------------ --------------
#    --domains-file           -d CSV file: Domains File                                             domains.csv
#    --algorithms-file        -a CSV file: Algorithms file                                          algorithms.csv
#    --exe-algorithms         -r Execute Algorithms Setup                                           true
#    --ignore-errors          -i Ignore errors while adding domains/algorithms                      false
#    --log-file               -o Log file name                                                      Current date_time.log"
#    --proxy-bypass           -x Proxy ByPass                                                       true
#    --https-insecure         -k Make Https Insecure                                                false
#    --masking-engine         -m Masking Engine Address                                             Required Value
...
#    --help                   -h help
#
#    Example: dpxcc_setup_domains.sh -m <Masking IP> -u <Masking User> -p <Masking Password>
#
```
